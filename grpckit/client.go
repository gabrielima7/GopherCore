...
// Internal Logic Deep-Dive: Configures the gRPC client to use insecure (plaintext) credentials.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Configures the gRPC client to use the provided TLS credentials.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Sets a timeout on the custom dialer to enforce a deadline on the initial network connection.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Appends unary interceptors to the gRPC client configuration.
...
// Constraints: Nil interceptors in the variadic slice are silently skipped.
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Appends stream interceptors to the gRPC client configuration.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Appends raw grpc.DialOption values to the client configuration.
