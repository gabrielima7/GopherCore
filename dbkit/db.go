...
// Internal Logic Deep-Dive: Encapsulates generic SQL configuration details independent of the specific driver.
type Config struct {
...
// Internal Logic Deep-Dive: Provides standard connection limits and lifetime settings to prevent database connection exhaustion.
...
// Internal Logic Deep-Dive: Applies standard database tuning via functional options pattern to control connection pools.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Applies standard database tuning via functional options pattern to manage idle pool size.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Applies standard database tuning via functional options pattern to recycle stale connections.
...
// Constraints: Must be >= 0.
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Applies standard database tuning via functional options pattern to close long-idle connections.
...
// Internal Logic Deep-Dive: Strictly fails fast if the DB isn't reachable during bootstrap to prevent phantom startups.
...
// Internal Logic Deep-Dive: Issues a lightweight PING against the underlying connection to verify active liveness.
