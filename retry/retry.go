...
// Internal Logic Deep-Dive: Encapsulates retry behaviors such as jitter and backoff multipliers.
type Config struct {
...
// Internal Logic Deep-Dive: Limits bounded retries strictly.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Sets the baseline timing before applying backoff multipliers.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Caps exponential backoff preventing infinitely increasing pauses.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Assigns algorithmic behavior (e.g., constant, exponential) to the retry engine.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Adds randomized micro-delays to prevent thundering herd phenomena.
...
// Thread-safety: Mutates configuration synchronously.
// Internal Logic Deep-Dive: Executes conditional matching on specific error types before allowing a retry.
...
// Internal Logic Deep-Dive: Integrates directly with context deadlines to halt loops cleanly on cancellation.
