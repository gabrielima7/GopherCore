...
// Internal Logic Deep-Dive: Configures allowed origins for the CORS middleware.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Replaces the default rate limiter with a custom implementation.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Configures the request rate limit for the server.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Sets the read timeout on the HTTP server configuration.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Sets the read header timeout on the HTTP server configuration.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Sets the write timeout on the HTTP server configuration.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Sets the idle connection timeout on the HTTP server configuration.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Enables request logging middleware on the router.
...
// Thread-safety: Mutates configuration struct safely during synchronous initialization.
// Internal Logic Deep-Dive: Configures the endpoint path for exposing Prometheus metrics.
...
// Internal Logic Deep-Dive: Creates a chi.Mux router and applies the configured middleware chain.
...
// Internal Logic Deep-Dive: Creates an http.Server struct initialized with the router's timeout configurations.
...
// Internal Logic Deep-Dive: Listens for OS signals and calls server.Shutdown with a context to stop gracefully.
